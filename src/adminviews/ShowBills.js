...
function ShowBills(){
    ...
    useEffect(()=>{
        axios.get("https://server-app-xite.onrender.com/customer/getcustomerlist").then((res)=> setCustList(res.data))
        axios.get("https://server-app-xite.onrender.com/product/showproduct").then((res)=> setPList(res.data))
        .catch((err)=> alert(err));
    },[]);
    ...
    const handleCustomerSelect=(evt)=>{
        ...
        axios.get(`https://server-app-xite.onrender.com/bill/billshow/${cid}`).then((res)=>{
        ...
        try{
            ...
            for(const bill of billdetailslist){
                ...
                for(let i=0;i<bill.products.length;i++){
                    ...
                    const imgUrl=`https://server-app-xite.onrender.com/product/getproductimage/${prod.pic}`;
                                ...
                                <React.Fragment key={bill.billid}>
                                    {bill.products.map((prod, idx)=>(
                                        <tr key={`${bill.billid}-${idx}`}>
                                            ...
                                            <td>
                                                <img src={`https://server-app-xite.onrender.com/product/getproductimage/${prod.pic}`}
